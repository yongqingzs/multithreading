...
public:
    ...
    void outMsgRecvQueue()
    {
        ...
        for (int i = 0; i < 100; ++i)
        {
            ...
            if (result == true)
            {
                cout << "outMsgRecvQueue() executed, retrieved element " << command << endl;
                //可以考虑进行命令（数据）处理
                //.....
            }
            else
...
public:
    ...
    void inMsgRecvQueue()
    {
        for (int i = 0; i < 100; ++i)
        {
            ...
            {
                //没拿到锁
                cout << "inMsgRecvQueue() executed, but did not get the lock, doing something else " << i << endl;
            }
        }
    }
...
public:
    ...
    void inMsgRecvQueue()
    {
        for (int i = 0; i < 100; ++i)
        {
            ...
            //{
            //  //没拿到锁
            //  cout << "outMsgEecvQueue() executed, but the message queue is empty " << i << endl;
            //}
